...
public abstract class AbstractRomHandler implements RomHandler {
    ...
    @Override
    public void randomizeMovesLearnt(boolean typeThemed, boolean noBroken, boolean forceStartingMoves, int forceStartingMoveCount, double goodDamagingProbability) {
        // Get current sets
